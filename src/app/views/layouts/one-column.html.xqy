...
declare variable $username as xs:string? := if (xdmp:get-current-user() = "edrms-user") then () else xdmp:get-current-user();
declare variable $q as xs:string? := vh:get("q");

'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">',
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:_1="http://www.w3.org/1999/xhtml">
  <head>
  ...
  <body>
    <div class="home" id="home">
      <a class="text" href="/" title="Home">Denormalisations with Norm</a>
    </div>
    {
      uv:build-user($username, fn:concat("/sec/profile?user=", $username), "/sec/login", "/sec/register", "/sec/logout")
    }
    <script type="text/javascript">var userid="{$username}";</script>
    <div class="canvas">
      <div class="header" arcsize="5 5 0 0">
        <a href="/">Home</a> | 
        <a href="/norm/summary">Denormalisations</a>
      </div>
      <div class="content">
        { $view }
      </div>
