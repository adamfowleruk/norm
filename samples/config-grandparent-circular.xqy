...
xdmp:document-insert("/admin/config/norm-test.xml",<n:denormalisation>
 ...
 <n:template>
  <n:element ns="pa"  name="programme-availability">
   ...
   <n:element ns="tv" name="brand" source="s3" source-path="/tv:brand/*" />
  </n:element>
 </n:template>
 ...
 <n:sources>
  <n:source id="s3" name="brand" root-xpath="fn:collection(""brand"")" mode="create-update" required="false">
   ...
   <n:primary-key><n:ns>tv</n:ns><n:element>brand</n:element><n:attribute>pid</n:attribute></n:primary-key>
   <n:foreign-key primary-entity="s2" key-ns="tv" key-element="series" key-attribute="pid"><n:ns>tv</n:ns><n:element>brand</n:element><n:attribute>series-pid</n:attribute></n:foreign-key>
  </n:source>
  <n:source id="s4" name="availability" root-xpath="fn:uris(""/availabilities/*"")" mode="create-update" required="true">
   ...
   <n:foreign-key primary-entity="s3" key-ns="tv" key-element="brand" key-attribute="pid"><n:ns>tv</n:ns><n:element>availability</n:element><n:attribute>brand-pid</n:attribute></n:foreign-key>
